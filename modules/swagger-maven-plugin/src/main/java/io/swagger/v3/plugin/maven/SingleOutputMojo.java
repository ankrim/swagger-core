...
public class SingleOutputMojo extends AbstractMojo {
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    try {
      ...
      if (SwaggerMojo.Format.JSON.equals(outputFormat) || SwaggerMojo.Format.JSONANDYAML.equals(outputFormat)) {
      ...
      if (SwaggerMojo.Format.YAML.equals(outputFormat) || SwaggerMojo.Format.JSONANDYAML.equals(outputFormat)) {
        if (config.isPrettyPrint() != null && config.isPrettyPrint()) {
  ...
  protected boolean isCollectionNotBlank(Collection<?> collection) {
  ...
  private SwaggerMojo.Format outputFormat = SwaggerMojo.Format.JSON;
